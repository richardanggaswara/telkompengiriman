			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<div id="content">
						...
						<!-- title -->
						<div id="page-title">
							<span class="title">Pencarian History</span>
							<span class="subtitle">Pencarian data logistik history terhadap <i>form report</i> data Telkom</span>
						</div>
						<!-- ENDS title -->
