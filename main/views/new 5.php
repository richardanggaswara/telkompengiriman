...
<html>
	<head>
		...
		<script type="text/javascript" charset="utf-8" src="<?php echo base_url();?>/assets/datatables/js/jquery.jeditable.js"></script>
		<script type="text/javascript" charset="utf-8">
			$(document).ready( function () {
				var oTable = $('#example').dataTable( {
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "reportbarang/searchkol",
					"oTableTools": {
							...
							<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
								<thead>
									<tr>
										...
										<th>No Ijin Jasa Pengiriman</th>
										<th>Kode Prov Kirim</th>
										<th>Kode Prov Asal</th>
										<th>Pegawai Jasa yang bertugas</th>
										<th>Pegawai Jasa yang menerima</th>
										<th>Tanggal Kirim</th>	
										<th>Alamat Kirim</th>	
										<th>Status Kirim</th>										
									</tr>
