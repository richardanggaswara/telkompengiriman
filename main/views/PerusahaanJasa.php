		...
		<script type="text/javascript" charset="utf-8">
			$(document).ready( function () {
				$('#example').dataTable( {
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "perusahaanjasa/searchjas",
					"oTableTools": {
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<div id="content">
						...
						<!-- title -->
						<div id="page-title">
							<span class="title">Pencarian Perusahaan Jasa</span>
							<span class="subtitle">Pencarian data perusahaan jasa terhadap <i>form report</i> data yang menjalin kerjasama dengan Telkom</span>
						</div>
						<!-- ENDS title -->
