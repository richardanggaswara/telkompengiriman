				...
				<div class="wrapper">
					...
					<div id="content">
						...
						<?php echo validation_errors('<p class="error">'); ?>
							<?php echo form_open('inputperusahaan'); ?>
							<div class="span5">
							<!-- Text input-->
							<div class="control-group">
							  <label class="control-label" for="namaperusahaan"><b>Nama Perusahaan</b></label>
							  <div class="controls">
								<input id="namaperusahaan" name="namaperusahaan" type="text" placeholder="nama" class="input-large" value="<?php echo set_value('namaperusahaan'); ?>" required="">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<select id="subsektorindustri" name="subsektorindustri" value="<?php echo set_value('subsektorindustri'); ?>" class="input-large">
								  ...
								  <option>Elektronik Industrial</option>
								</select>
							  </div>
							</div>
